...
namespace AgentBot.Services
{
    ...
    public interface ILlmWrapper
    {
        ...
        /// </summary>
        Task<string> BuildSystemPromptAsync(UserContext context);
    ...
    public class LlmWrapper : ILlmWrapper
    {
        ...
        public async Task<string> BuildSystemPromptAsync(UserContext context)
        {
            var sb = new StringBuilder();

            sb.AppendLine("Ты — умный помощник в Telegram-боте.");
